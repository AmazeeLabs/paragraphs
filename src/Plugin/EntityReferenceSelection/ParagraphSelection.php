  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    if (!count($bundle_options)) {
      $form['allowed_bundles_explain'] = array(
        '#type' => 'markup',
        '#markup' => t('You did not add any paragraph types yet, click !here to add one.', array('!here' => \Drupal\Core\Link::fromTextAndUrl(t('here'), new Url('paragraphs.type_add', array()))))
      );
    }
